import { Ticket, Layers, ArrowRight, BarChart2, MessageSquare } from 'lucide-react'; // <--- PlusCircle removido
        ...
        <div className="flex-1 flex flex-col h-full bg-light-bg dark:bg-dark-bg p-6 md:p-10 animate-fadeIn">
            ...
            <div className="w-full h-full flex flex-col">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 w-full">
                    ...
                    >
                        ...
                        <div className="relative z-10">
                            ...
                            <p className="text-sm text-gray-500 font-medium">
                                {isStaff ? "Tickets que você assumiu." : "Acompanhe suas solicitações."}
                            </p>
                        </div>
                    ...
                    {/* CARD 2: VARIAVEL (Staff = Inbox / Cliente = IA Chat) */}
                    {isStaff ? (
                        <button
                        ...
                        >
                            ...
                            <div className="relative z-10">
                                ...
                                <p className="text-sm text-gray-500 font-medium">Tickets pendentes de toda a equipe.</p>
                            </div>
                        ...
                        <button
                            onClick={() => onNavigate('ia_support')} // AQUI VAI PARA A IA
                        ...
                        >
                            ...
                            <div className="relative z-10">
                                ...
                                <h3 className="font-bold text-2xl text-light-text dark:text-dark-text mb-2">Atendimento Inteligente</h3>
                                <p className="text-sm text-gray-500 font-medium">Fale com a Kovia AI ou abra um ticket.</p>
                            </div>
                            <div className="relative z-10 flex items-center text-blue-500 font-bold text-sm group-hover:translate-x-2 transition-transform mt-4">
                                Iniciar Chat <ArrowRight size={16} className="ml-2" />
                            </div>
                        </button>
                    )}

                    {/* CARD 3: EXTRA (Só para Staff) */}
                    {isStaff && (
                        <button
                        ...
                        >
                            ...
                            <div className="relative z-10">
                                ...
                                <p className="text-sm text-gray-500 font-medium">Analise gargalos e tempos.</p>
                            </div>
